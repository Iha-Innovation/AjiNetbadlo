...
?>
    ...
    <div class="breadcrumb-area bg-img bg-overlay-3 jarallax wow fadeInUp" data-wow-delay="200ms" style="background-image: url(img/bg-img/30.jpg);">

    
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
  
            <div class="col-md-12" style="top: 41px;">
                        ...
                        <div class="property-desc-area">
                            ...
                            <div class="property-title-seller d-flex justify-content-between">
                                ...
                                <div class="property-title">
                                    ...
                                    <p><i class="fa fa-map-marker" aria-hidden="true"></i> GA 125, Casablanca</p>
                                </div>
                                <!-- Seller -->
    ...
    <section class="rehomes-choose-us-area section-padding-100-60">
        <div class="container">
            <div class="row">
                ...
                <div class="col-12 col-md-6 col-lg-4" style="max-width:100%; flex: 1 0 0%;">
                    <div class="single-choose-us-content wow fadeInUp" data-wow-delay="200ms">
                        <!-- Choose us Icon -->
                        <div class="choose-us-icon"style="padding-left: 495px;">
                            <i class="icon_search"></i>
                        </div>
                        <h5 style="text-align:center;">Trouver votre maison</h5>
                        <p>Avec AjiNetbadlo vous pourrez échanger votre maison pour les vacances ou vous cherchez la proximité de votre boulot . Profitez de vacances différentes en échangeant votre maison avec des personnes d'autres villes. Visitez de nouvelles villes de manière économique . </p>
                    </div>
                </div>
